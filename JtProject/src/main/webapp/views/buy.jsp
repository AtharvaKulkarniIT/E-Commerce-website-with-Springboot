    ...
    <div class="form-container">
      <div class="personal-information">
        <h1>Payment Detalis</h1>
          ...
          <input id="input-field" type="text" name="number" pattern="[0-9]*" minlength="12" maxlength="12" placeholder="Card Number"/>
          <input id="column-left" type="text" name="expiry" placeholder="MM / YY"/>
          <input id="column-right" type="text" name="cvv" minlength="3" maxlength="3"  placeholder="CVV"/>
